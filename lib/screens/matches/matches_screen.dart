...
class _MatchesScreenState extends State<MatchesScreen> {
  ...
  // Késleltetéshez (debounce) szükséges időzítő
  ...
  // Késleltetett keresési metódus (biztonsági / teljesítmény optimalizáció)
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                TextField(
                  onChanged: _onSearchChanged, // Késleltetett keresés meghívása
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, leagueIndex) {
                    ...
                    final isCollapsed = _collapsedLeagues.contains(leagueName);
