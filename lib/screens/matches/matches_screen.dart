...
// ==========================================
// RUGALMAS ÉS PONTOS KÖZPONTI FORDÍTÓ OSZTÁLY
// ==========================================
class AppTranslator {
  ...
  // Kulcsszó alapú, de szigorú szűrés és magyarítás
  static String? getTranslatedLeague(String leagueName) {
    ...
    // Magyarország
    if (l.contains('nb i') || l.contains('nb 1') || l.contains('hungary 1') || l.contains('otp bank liga')) return 'Magyarország - NB I';
    if (l.contains('nb ii') || l.contains('nb 2') || l.contains('hungary 2')) return 'Magyarország - NB II';
    ...
    if (l.contains('first division b') || l.contains('belgium 2')) return 'Belgium - 2. Osztály';
    ...
    if (l.contains('kosovo') && l.contains('superleague')) return 'Koszovó - 1. Osztály';
    ...
    if (l.contains('macedonian') && l.contains('first')) return 'Észak-Macedónia - 1. Osztály';
    ...
    if (l.contains('brazileiro serie a') || (l.contains('serie a') && l.contains('brazil'))) return 'Brazília - 1. Osztály';
    if (l.contains('brazileiro serie b') || (l.contains('serie b') && l.contains('brazil'))) return 'Brazília - 2. Osztály';
    ...
    return null; // Minden más kiszűrve
  }
}
